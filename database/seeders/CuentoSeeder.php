...
class CuentoSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Cuento::create(
            [
                'titulo' => 'El patito feo', #73 palabras
        ...
        Cuento::create(
            [
                'titulo' => 'La liebre y la tortuga', #97 palabras
        ...
        Cuento::create(
            [
                'titulo' => 'The Ant And The Grasshopper', #142 palabras
        ...
        Cuento::create(
            [
                'titulo' => 'Ozymandias', #111 palabras
                'contenido' => 'I met a traveler from an antique land, Who said— “Two vast and trunkless legs of stone stand in the desert. . . . Near them, on the sand, half sunk a shattered visage lies, whose frown, and wrinkled lip, and sneer of cold command tell that its sculptor well those passions read, which yet survive, stamped on these lifeless things, the hand that mocked them, and the heart that fed; and on the pedestal, these words appear: My name is Ozymandias, King of Kings; Look on my Works, ye Mighty, and despair!... Nothing beside remains. Round the decay of that colossal Wreck, boundless and bare. The lone and level sands stretch far away.”',
                'dificultad' => 'alta',
            ]
        );
        ...
        Cuento::create(
            [
                'titulo' => 'The King of Kong: A Fistful of Quarters', #82 palabras
        ...
        Cuento::create(
            [
                'titulo' => 'The Call of Cthulhu', #47 palabras
        ...
        Cuento::create(
            [
                'titulo' => 'Shawshank Redemption', #75 palabras
        ...
        Cuento::create(
            [
                'titulo' => 'Hollow Knight', #41 palabras
        ...
        Cuento::create(
            [
                ...
                'titulo' => 'Entrenamiento de la Escuela de la Tortuga', #31 palabras
        ...
        Cuento::create(
            [
                'titulo' => 'The Monty Python and the Holy Grail', #32 palabras
        ...
        Cuento::create(
            [
                'titulo' => 'How to Win Friends and Influence People', #21 palabras
        ...
        Cuento::create(
            [
                'titulo' => 'La Mitrailleuse', #47 palabras
        ...
        Cuento::create(
            [
                'titulo' => 'Ezekiel 25:17', #94 palabras
        ...
        Cuento::create(
            [
                'titulo' => 'Rocky Balboa', #41 palabras
        ...
        Cuento::create(
            [
                'titulo' => 'Forrest Gump', #53 palabras
                'contenido' => 'One day it started raining, and it did not quit for four months. We have been through every kind of rain there is. Little bitty stinging rain... and big old fat rain. Rain that flew in sideways. And sometimes rain even seemed to come straight up from underneath. Shoot, it even rained at night.',
                'dificultad' => 'media',
            ]
        );
        ...
        Cuento::create(
            [
                'titulo' => 'Hawkeye Gough', #50 palabras
                'contenido' => 'The dragons shall never be forgotten… We knights fought valiantly, but for every one of them, we lost three score of our own. Exhilaration, pride, hatred, rage… The dragons teased out our dearest emotions. …Thou will understand, one day. At thy twilight, old thoughts return, in great waves of nostalgia.',
                'dificultad' => 'alta',
            ]
        );
        ...
        Cuento::create(
            [
                'titulo' => 'Ancient One', #54 palabras
        ...
        Cuento::create(
            [
                'titulo' => 'We Can Do This', #59 palabras
